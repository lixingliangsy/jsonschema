 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="jsonschema" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "jsonschema";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "jsonschema") + "_chat_session";
