...
const howToSteps = [
  { name: 'Open JSONSchema', text: 'Go to the workspace and enter the inputs JSONSchema asks for.' },
  { name: 'Generate the draft', text: 'Run JSONSchema to get a structured plain-English result.' },
...
export default function Page() {
  ...
  const SHORT = "JSONSchema turns a sample JSON object into a strict JSON Schema (draft 2020-12), explains each required field, and…"
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">JSONSchema turns a sample JSON object into a strict JSON Schema (draft 2020-12), explains each required field, and…</p>
