  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={NAME + " — How JSONSchema handles your data and the compliance posture it maintains."} />
      </Head>
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-slate-600">JSONSchema turns a sample JSON object into a JSON Schema (draft 2020-12), explains each required field, and screens it with a deterministic compliance ruleset (type/required/format/enum). Export the schema your API can enforce.</p>
          <h2 className="mt-8 text-xl font-semibold text-slate-900">What we handle</h2>
          <p className="mt-2 text-slate-600">JSONSchema processes the text or configuration you submit to produce its output. We do not train public models on your submissions without explicit consent.</p>
