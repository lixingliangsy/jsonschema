import { saveRun as _saveRunStore } from './runStore'
...
export const PIPELINE_ID = 'jsonschema-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Paste sample JSON object",
  process: "Step 2/3 · Infer draft 2020-12 schema",
  output: "Step 3/3 · Schema + plain-language rules",
}
...
export function saveRun(state: any) { return _saveRunStore(state) }
